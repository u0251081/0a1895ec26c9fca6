...
　               <option value="Early morning">凌晨 00:00 ~ 6:59</option>
            ...
            <thead>
            <tr>
                <th colspan="5"><h4 style="font-family: '微軟正黑體'; font-weight: bold; color: #d62408;" id="change">導流查詢<br>您目前成功導購數為：<br><?php if(!empty($rows))
                { 
        ...
        <div id="Layer1" style="overflow:auto; height: 400px;">
        <table class="table table-bordered table-responsive table-condensed" id="inserttable">
...
<script>
    ...
    var page=$('#page').val();
    var date=$('#date').val();
    var arr = <?php echo json_encode($array1)?>;
    arr=Object.keys(arr);
     ...
     $.ajax
            ({
                ...
                success:function(data)
                {
                  ...
                  $("#total").append("<p>總共:"+i+"筆</p>");
                  $("#change").append("<p>粉絲團編號導流查詢</p><p>搜尋編號:"+page+"</p><p>導流次數:"+i+"次</p><p>導購數量:"+count+"筆</p>");   
