...
<section id="aa-catg-head-banner">
    <div class="container">
        ...
        <div class="aa-catg-head-banner-content">
            <ol class="breadcrumb">
                <li><a href="index.php?page=<?php echo $page;?>">首頁</a></li>
...
<!--                    </div>-->
                    ...
                    <div class="form-group" id="btn_panel">
                        ...
                        <div class="col-md-8">
                            ...
                            <input type="button" class="btn btn-default btn-block" onclick="location.href='index.php?url=member_center&page=<?php echo $page;?>'" value="返回會員專區">
                        </div>
                    </div>
                </form>
            </div>
