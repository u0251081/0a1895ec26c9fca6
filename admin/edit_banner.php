                 ...
                 <p>
                    ...
                    <span class="field">
                        ...
                        {?>
                            ...
                            <input type="radio" name="page" <?php if($rowpage['id']==$row['page'] ){echo'checked'; }?> value=<?php echo $rowpage['id'];?>><?php echo $rowpage['page_name']; ?>&nbsp;&nbsp; 
    ...
    if(isset($_POST['btn']))
    {
        if($banner_img != "" || $mobile_banner_img != "")
        {
            if($banner_img != "")
            {
                ...
                $sql = "UPDATE banner SET p_id='$p_id', title='$banner_title',url='$banner_url',page='$page',img='".$filedir.$banner_img."', `status`='$status' WHERE id='$id'";
                mysql_query($sql);
            }
            ...
            if($mobile_banner_img != "")
            {
                ...
                $sql = "UPDATE banner SET p_id='$p_id', title='$banner_title',url='$banner_url',page='$page', mobile_img='".$filedir2.$mobile_banner_img."', `status`='$status' WHERE id='$id'";
                mysql_query($sql);
            }
        }
        else
        {
            ...
            $sql = "UPDATE banner SET p_id='$p_id', title='$banner_title',url='$banner_url',page='$page', img='".$banner_img."', mobile_img='".$mobile_banner_img."', `status`='$status' WHERE id='$id'";
            mysql_query($sql);
        }
        ?>
        <script>
