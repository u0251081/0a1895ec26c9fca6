...
include_once("product_send_email.php");
sql();
switch(@$_POST['type'])
{
    case 'get_area':
...
function admin_update_order()
{
    ...
    $p_name_array=$_POST['p_name_array'];
    $p_price_array=$_POST['p_price_array'];
    $p_qty_array=$_POST['p_qty_array'];
    $order_time=$_POST['order_time'];
    $pay_type=$_POST['pay_type'];
    $all_price=$_POST['all_price'];
    $p_id_array=$_POST['p_id_array'];

    if($is_effective=='3')
    {
        product_send_email($order_no,$p_name_array,$order_time,$order_m_id,$addressee_address,$addressee_cellphone,$pay_type,$all_price,$addressee_name,$p_id_array,$p_price_array,$p_qty_array);
    }
