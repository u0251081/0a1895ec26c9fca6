...
<div class="widget">
    ...
    <div class="widgetcontent">
        <form class="stdform stdform2" method="post">
            ...
            <p>
                ...
                <span class="field" style="font-size: 3.3vh;">
                    ...
                    for($i=0; $i<$num; $i++)
                    {
                        ...
                        $p_name_array[$i]=$p_name[$i];
                        $p_price_array[$i]=$p_web_price[$i];
                        $p_qty_array[$i]=$qty[$i];
                        $p_id_array[$i]=$p_id[$i];
            ...
            <p>
                <label>總價</label>
                <span class="field" style="font-size: 3.3vh;"><?php $all_price=$o_price[0]; echo $all_price; ?></span>
            </p>
            <p>
                <label>付款方式</label>
                <span class="field" style="font-size: 3.3vh;">
            ...
            <p>
                <label>購買日期</label>
                <span class="field" style="font-size: 3.3vh;"><?php $order_time= $order_time[0]; echo $order_time; ?></span>
            </p>
            <p>
                <label>收件人資訊</label>
                <span class="field" style="font-size: 3.3vh;">
                    ...
                    $addressee_address=$addressee_row['address'];
                    $addressee_cellphone=$addressee_row['cellphone'];
                    $addressee_name=$addressee_row['name'];
...
<script>
    ...
    function save()
    {
        ...
        var order_email="<?php echo $order_email;?>";
        ...
        var p_name_array=<?php echo json_encode($p_name_array); ?>;
        var p_price_array=<?php echo json_encode($p_price_array); ?>;
        var p_qty_array=<?php echo json_encode($p_qty_array); ?>;
        var p_id_array=<?php echo json_encode($p_id_array); ?>;
        ...
        if(addressee_name != "" && addressee_cellphone != "" && addressee_address != "" && addressee_date != "" && is_effective!=2)
        {
            ...
            ({
                url:"sever_ajax.php",
                type:"POST",
               data:{type:"admin_update_order", order_no:order_no, order_m_id:order_m_id, is_effective:is_effective, addressee_name:addressee_name, addressee_cellphone:addressee_cellphone, addressee_address:addressee_address, addressee_date:addressee_date,p_name_array:p_name_array,p_qty_array:p_qty_array,p_price_array:p_price_array,order_time:order_time,pay_type:pay_type,all_price:all_price,p_id_array:p_id_array},
                dataType:"text",
                success:function(i)
                {
                    if(i == 1)
