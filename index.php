              ...
              <div class='aa-header-top-left'>
                  <div class="aa-header-top-right">
					  ...
					  <!--<li class="hidden-xs"><a href="index.php?url=wishlist">追蹤清單</a></li>
						  ...
						  {
							  ?>
							  <li><a href="index.php?url=member_center&page=<?php echo $page;?>">會員專區</a></li>
							  <li>
								<?php
								  if(@$_SESSION['front_id'] != "")
								  {
									  ?>
									  <a href="logout.php?page=<?php echo $page;?>">登出</a>
									  <?php
								  }
								  else
								  {
									...
									<li><a href="index.php?url=login&page=<?php echo $page;?>">註冊</a></li>
									<?php
								  }
						  }
						  ?>
            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-logo">
                <a href="index.php?page=<?php echo $page;?>">
                  ...
                  <p><?php echo $page_name;?><span>電子商城</span></p>
                </a>
              </div>
              <!-- / logo  -->
            </div>
                ...
                <div class="aa-footer-widget">
                  <h3>關於我們</h3>
                   <ul class="aa-footer-nav">
                    <li><a href="javascript:void(0);" data-toggle="modal" data-target=<?php if($status[3]['status']=="0"){echo '#';}else{echo '#introduce-modal';}?>>商店簡介</a></li>
                  </ul>
                </div>
              </div>
              <div class="col-md-3 col-sm-6">
                <div class="aa-footer-widget">
                  <div class="aa-footer-widget">
                   ...
                   <ul class="aa-footer-nav">
                      ...
                      <li><a href="javascript:void(0);" data-toggle="modal" data-target=<?php if($status[2]['status']=="0"){echo '#';}else{echo '#private-modal';}?>>隱私權條款</a></li>
                       <li><a href="javascript:void(0);" data-toggle="modal" data-target=<?php if($status[1]['status']=="0"){echo '#';}else{echo '#member-modal';}?>>會員權益聲明</a></li>
                    </ul>
                  </div>
                </div>
              </div>
      ...
      <div class="modal-content">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          ...
          <form class="aa-login-form">
           ...
           <p class="aa-lost-password"><a href="index.php?url=forget_password&page=<?php echo $page;?>">忘記密碼?</a></p>

            <div class="aa-register-now">

               還沒有帳號嗎?<a href="index.php?url=login&page=<?php echo $page;?>">註冊</a>
            </div>
          </form>
        </div>
      </div><!-- /.modal-content -->
  ...
  <div class="my_nav">
      <ul>
          ...
          <li style="position:relative;">
              <a href="index.php?url=member_center&page=<?php echo $page;?>"><span><img src="img/icon/foot-member.png"></span><span>會員專區</span></a>
          </li>
          <li id="li3">
          ...
          <li>
              <a href="index.php?url=cart&page=<?php echo $page;?>"><span><img src="img/icon/shopcart_icon.png"></span><span>購物車</span></a>
          </li>
      </ul>
  </div>
...
<script type="text/javascript">
 ...
 (function(d, s, id) {
  ...
  js.src = 'https://connect.facebook.net/zh_TW/sdk.js#xfbml=1&version=v2.11&appId=189278774964582';
