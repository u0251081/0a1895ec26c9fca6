                ...
                <div class="aa-promo-area">
                    <div class="row">
                        ...
                        <div class="tab-content ax">
                            ...
                            <?php
                            $sqlpm ="SELECT * FROM page_manager WHERE id='$page' and status='1'";
                            $respm=mysql_query($sqlpm);
                            $rowpm = mysql_fetch_array($respm);
                            @$s_id=$rowpm['s_id'];

                           $sql = "SELECT * FROM supplier WHERE id IN($s_id) AND auth='2' AND added='1' ";
                            $res = mysql_query($sql);
                            $num = mysql_num_rows($res);
                            if($num==0)
                            {         
                                echo "<script type='text/javascript'>";
                                echo "location.href='/index.php?page=$main_page'";
                                echo "</script>"; 
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <article class="aa-latest-blog-single" style="height:350px;">
                                        <figure class="aa-blog-img">
                                            <a class="aa-product-img" href="index.php?url=introduce&page=<?php echo $page;?>&supplier_id=<?php echo $row['id']; ?>">
                                                <?php
                                        ...
                                        <div class="supplier-img">
                                            <a class="supplier-img" href="index.php?url=introduce&page=<?php echo $page;?>&supplier_id=<?php echo $row['id']; ?>">
                                          <?php
                                        ...
                                        <div class="aa-blog-info">
                                            <center><h3 class="aa-blog-title" style="color: red;"><a href="index.php?url=introduce&page=<?php echo $page;?>&supplier_id=<?php echo $row['id']; ?>" style="color: red;"><?php echo $row['supplier_title']; ?></a></h3></center>
                                            <?php
