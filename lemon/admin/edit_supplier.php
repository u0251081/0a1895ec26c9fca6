...
if(isset($_POST['btn']))
{
    ...
    if($added=="0")
    {
        $sqldown ="UPDATE supplier,product SET supplier.added='0',product.added='0' WHERE supplier.id=product.s_id AND supplier.id='$id'";
        mysql_query($sqldown);
    }
...
cellphone='$cellphone', info='$info', info2='$info2', city_id='$city_id', area_id='$area_id',added='$added', address='$address' WHERE id='$id'";
    mysql_query($sql);
    ?>
    <script>
        alert('修改成功');
