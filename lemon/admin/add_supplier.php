        ...
        <form class="stdform stdform2" method="post" enctype="multipart/form-data">
            ...
            <p>
             ...
             <p>
                <label>是否上架</label>
                <span class="field">
                    <input type="radio" name="added" checked class="input-large" value="1" />上架&nbsp;&nbsp;
...
if(isset($_POST['btn']))
{
 ...
 city_id='$city_id', area_id='$area_id', address='$address', info2='$info2',added='$added',auth='2', big_img='".$filedir.$big_img."', small_img='".$filedir2.$small_img."', registration_time='".date('Y-m-d H:i:s')."'";
    mysql_query($sql);
    ?>
    <script>
        alert('新增成功');
