...
<div class="container" id="pay_check_div">
    <div class="row">
        <table class="table table-bordered table-responsive table-condensed">
            ...
            <tr>
                <th colspan="5">
                    <h3 style="font-family: '微軟正黑體'; font-weight: bold; color: #d62408;">Cek points<br>Total points anda saat ini adalah:<?php if($bonus_row['bonus']!=""){ echo "<span id='now_bonus'>".$bonus_row['bonus']."</span>"; }else{echo 0;} ?>Points</h3>
                </th>
            </tr>
            ...
            <tr align="right">
                <td colspan="5">
                    <div class="container">
                        <div class="row">
                            <input type="button" class="btn btn-default" value="Kembali ke" onclick="location.href='index.php?url=member_center'">&nbsp;&nbsp;
                            <input type="button" class="btn btn-info" value="Rekor pertukaran" onclick="location.href='index.php?url=bonus_use'">
                        </div>
                    </div>
                </td>
            </tr>
