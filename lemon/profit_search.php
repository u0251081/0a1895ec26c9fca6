...
<div class="container" id="pay_check_div">
    <div class="row">
        <table class="table table-bordered table-responsive table-condensed">
            <thead>
            <tr>
                <th colspan="5"><h4 style="font-family: '微軟正黑體'; font-weight: bold; color: #d62408;">Cek keuntugan<br>Kumulatif anda saat ini adalah:<?php if($bonus_row['profit']!=""){ echo $bonus_row['profit']; }else{echo 0;} ?>元</h4></th>
            </tr>
            <tr style="background: #DDDDDD;">
                <th>VIP sharer</th>
                <th>Pembeli</th>
                <th>Membeli produk</th>
            ...
            <tr align="right">
                <td colspan="5">
                    <div class="container">
                        <div class="row">
                            <input type="button" class="btn btn-default" value="Kembali ke" onclick="window.history.back(-1);">&nbsp;&nbsp;
                        </div>
                    </div>
                </td>
            </tr>
