                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <article class="aa-latest-blog-single">
                                            <figure class="aa-blog-img">
                                                 <a class="aa-product-img" href="index.php?url=product_detail&page=<?php echo $page;?>&product_id=<?php echo $product_row['0']; ?>">
                                            ...
                                            <div class="aa-blog-info">
                                                <h3 class="aa-blog-title"><a href="index.php?url=product_detail&page=<?php echo $page;?>&product_id=<?php echo $product_row['0']; ?>"><?php echo $product_row['p_name']; ?></a></h3>
                                                <?php
                                                ...
                                                {
                                                    ?>
                                                    <span class="aa-product-price"><?php echo "Harga ： NT$".$row['web_price']; ?></span><br>
