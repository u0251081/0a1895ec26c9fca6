...
$product_num=mysql_num_rows($product_res);
$maxpage=ceil($product_num/$total); 
    ...
    $start=$total*($p-1);
$product_sql = "SELECT * FROM product_class AS a JOIN product AS b ON a.product_id = b.id WHERE a.pid='$pid' AND b.added='1' ORDER BY b.add_day DESC LIMIT ".$start.",".$total;
$product_res = mysql_query($product_sql);
        ...
        <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-8 col-md-push-3">
                <div class="aa-product-catg-content">
                    <div class="aa-product-catg-body ax" style="position: relative;">
                        <?php
                        ...
                        if(@mysql_num_rows($product_res) > 0 )
                        {
                            while (@$product_row = mysql_fetch_array($product_res))
                            {
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <article class="aa-latest-blog-single" style="height: 450px;">
                                            <figure class="aa-blog-img">
                                                <a class="aa-product-img" href="index.php?url=product_detail&page=<?php echo $page;?>&product_id=<?php echo $product_row['product_id']; ?>">
                                                    <?php
                                            ...
                                            <div class="aa-blog-info">
                                                <h3 class="aa-blog-title"><a href="index.php?url=product_detail&page=<?php echo $page;?>&product_id=<?php echo $product_row['product_id']; ?>&pid=<?php echo $pid; ?>"><?php echo $product_row['p_name']; ?></a></h3>
                                                <?php
                               ...
                               echo "<center><div id='changepage'><a href=?page=".$_GET['page']."&url=product&p=1&pid=".$_GET['pid']." id='page'>首頁</a> ";
                        
                        for( $i=1 ; $i<=$maxpage ; $i++ ) {
                            if ( $p-3 < $i && $i < $p+3 ) {
                            echo "<a href=?page=".$_GET['page']."&url=product&p=".$i."&pid=".$_GET['pid']." id='page'>".$i."</a> ";
                        }
                        } 
                        echo "  <a href=?page=".$_GET['page']."&url=product&p=".$maxpage."&pid=".$_GET['pid']." id='page'>末頁</a></center>";
                        }
                        else
                        {
                            echo '<center><span style="color:red;">很抱歉，此分類暫無商品</span></div></center>';
                        }
            ...
            <div class="col-lg-3 col-md-3 col-sm-4 col-md-pull-9">
                <aside class="aa-sidebar">
                    ...
                    <div class="aa-sidebar-widget hidden-xs">
                        ...
                        if($row['id'] != "")
                        {
                            $real_class_sql= "SELECT * FROM class WHERE NOT id='$pid' AND id = parent_id and page=$page";
                            $real_class_res = mysql_query($real_class_sql);
                            while ($real_class_row = mysql_fetch_array($real_class_res))
                            {
                                ?>
                                <li><a href="index.php?url=product&page=<?php echo $page;?>&pid=<?php echo $real_class_row['id']; ?>"><?php echo $real_class_row['name']; ?></a></li>
                                <?php
                            }
                        }
                        else
                        ...
                        <div class="aa-recently-views" style="height: 700px;">
                            <ul>
                                ...
                                while (@$row = mysql_fetch_array($res))
                                {
                                    ?>
                                    <li>
                                        <a href="index.php?url=product_detail&page=<?php echo $page;?>&product_id=<?php echo $row['aid']; ?>" class="aa-cartbox-img">
