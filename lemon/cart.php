    ...
    <div class="container">
        ...
        <div class="aa-catg-head-banner-content">
            <ol class="breadcrumb">
                ...
                <li><a href="index.php?url=member_center">Area anggota</a></li>
                ...
                <div class="cart-view-area" style="margin-bottom: 100px; padding-top: 1px;">
                    <div class="cart-view-table">
                                    ...
                                    <tr>
                                        <td colspan="6" class="aa-cart-view-bottom">
                                            <div class="aa-cart-coupon">
                                                <input class="aa-cart-view-btn" type="button" onclick="location.href='index.php?page=<?php echo $page;?>'" value="Lanjut belanja">
                                            </div>
                                            <input class="aa-cart-view-btn" id="btn" type="button" value="Modifikasi jumlah">
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
                        ...
                        <div class="cart-view-total">
                            <h4>Jumlah keranjang belanja</h4>
                            ...
                            <a href="javascript:void(0)" id="to_pay" class="aa-cart-view-btn">Pergi ke kasir</a>
                        </div>
                    </div>
                </div>
            </div>
...
<form id="cart_form" action="index.php?url=pay_check&page=<?php echo $page;?>'" method="post">
        ...
        ({
            ...
            success:function(i) //成功就....
            {
                if(i == 1)
                {
                    ...
                    {
                        window.javatojs.showInfoFromJs('Pembaruan berhasil');
                        window.location.href='index.php?url=cart&page=<?php echo $page;?>';
                    }
                    else
                    {
