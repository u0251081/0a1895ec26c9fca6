    ...
    <div class="container">
        ...
        <div class="aa-catg-head-banner-content">
            <ol class="breadcrumb">
                ...
                <li class="active">Daftar pelacakan</li>
            </ol>
        </div>
    </div>
</section>
                                            ...
                                            while($row = mysql_fetch_array($res))
                                            {
                                                if($row['added'] == 1)
                                                {
                                                    ...
                                                    <tr id="tr<?php echo $row['id']; ?>">
                                                        ...
                                                        <td><?php echo '上架中'; ?></td>
                                                        <td><a class="aa-add-to-cart-btn add_cart_btn" p_id="<?php echo $row['p_id']; ?>" last_qty="<?php echo $row['rem_qty']; ?>">Tambahkan ke keranjang belanja</a></td>
                                                    </tr>
                                                    <?php
                                                }
                                            }
...
<script>
    ...
    $(".add_cart_btn").click(function()        if(last_qty <= 0)
