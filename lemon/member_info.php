            ...
            <div class="col-md-12 personal-info">
                <form class="form-horizontal" onSubmit="return form_stop()" role="form" method="post">
                    ...
                    if(@$_SESSION["member_no"] != "" && @$_SESSION["device"] != 'mobile' && $row['fb_id']=="")
                    {
                        ?>
                        <div class="form-group">
                            <label class="col-lg-3 control-label"><span style="color:red;">*</span>Kata sandi</label>
                            <div class="col-lg-8">
                   ...
                   {    
                    ...
                    ?>
                    <div class="form-group">
                        <label class="col-lg-3 control-label"><span style="color:red;">*</span>Nama anggota</label>
                        <div class="col-lg-8">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label"><span style="color:red;">*</span>Tanggal lahir</label>
                        <div class="col-lg-8">
...
<!--                    </div>-->
                        ...
                        <div class="col-lg-8">
                            <div class="ui-select">
                                <select name="sex" class="form-control">
                                    <option <?php if($row['sex'] == 1){echo 'selected';} ?> value="1">Laki-laki</option>
                                    <option <?php if($row['sex'] == 0){echo 'selected';} ?> value="0">Perempuan</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label"><span style="color:red;">*</span>HP</label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group" id="btn_panel">
                        ...
                        <div class="col-md-8">
                            <input type="submit" name="btn" class="btn btn-primary btn-block" value="Penyimpanan">
                            <input type="button" class="btn btn-default btn-block" onclick="location.href='index.php?url=member_center&page=<?php echo $page;?>'" value="Kembali ke area anggota">
                        </div>
                    </div>
                </form>
            </div>
