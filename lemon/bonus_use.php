...
<div class="container" id="pay_check_div">
    <div class="row">
        <table class="table table-bordered table-responsive table-condensed">
            ...
            <tr>
                <th colspan="4">
                    <h3 style="font-family: '微軟正黑體'; font-weight: bold; color: #d62408;">Rekor pertukaran</h3>
                </th>
            </tr>
            <tr style="background: #DDDDDD;">
                <th>Nama produk</th>
                <th width='50'>Points</th>
                <th>Waktu pertukaran</th>
                <th>Status</th>
            </tr>
            </thead>
            <tbody>
            ...
            <tr align="right">
                <td colspan="5">
                    <div class="container">
                        <div class="row">
                            <input type="button" class="btn btn-default" value="Kembali ke" onclick="location.href='index.php?url=bonus_search'">&nbsp;&nbsp;
                        </div>
                    </div>
                </td>
            </tr>
