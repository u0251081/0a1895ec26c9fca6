...
if(!empty($_SERVER['HTTP_CLIENT_IP'])){
  ...
  if(!empty($_GET['fb_no']))
  {
    ...
    {   
        ...
        if(empty($rowpre))
        {
         $sqlfan = "INSERT INTO fb_fans(name,page,storetime,ip,fans_id) VALUES ('$rowfb[1]','$fb_no','$time','$myip','$rowfb[0]')";
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12">
                                ...
                                <div class="aa-product-view-content">
                                    <h3>Nama Produk：<?php echo $row['p_name']; ?></h3>
                                    <div class="aa-price-block">
                                        <?php echo @$row['p_introduction']; ?>
                                    </div>
                                    <div class="aa-price-block">
                                        <span class="aa-product-view-price">Harga pasar：<?php echo "<del>NT$<span>".$row['price']."</span></del>"; ?></span><br>
                                        <span class="aa-product-view-price">Harga ：<?php echo "NT$<span id='price'>".$row['web_price']."</span>"; ?></span><br>
                                        <span class="aa-product-view-price">Poin：<?php echo $row['p_bonus']; ?></span>
                                        <?php
                                        if(@$_SESSION['manager_no'] != "")
                                        {
                                            ?>
                                            <br>
                                            <span class="aa-product-view-price">Keuntungan：<?php echo "NT$<span id='price'>".floor($row['web_price']*$row['p_profit']/100); ?></span>
                                            <?php
                                        }
                                        ?>
                                    </div>
...
<!--                                        <a href="http://line.naver.jp/R/msg/text/?{hi}" target="_blank"><img src="img/icon/line.jpg" width="32" height="32"></a>-->
                                    ...
                                    <div class="aa-prod-quantity">
                                        ...
                                        <p class="aa-prod-category">
                                            Sisa: <a href="javascript:void(0);" id="over_qty"><?php echo $over_qty <=0 ? 0 :$over_qty ; ?></a>
                                        </p>
                                    </div>
                                    <div class="aa-prod-view-bottom">
                                        <span class="my_cart_btn" name="add_cart_btn" b_type="0">TAMBAHKAN KE KERANJANG BELANJA</span>&nbsp;&nbsp;&nbsp;
                                        <span class="my_cart_btn" name="add_cart_btn" b_type="1">Bergabung dengan daftar pelacakan</span>&nbsp;&nbsp;&nbsp;
                    ...
                    <div class="aa-product-details-bottom">
                        <ul class="nav nav-tabs" id="myTab2">
                            <li><a href="#description" data-toggle="tab">Perkenalan terperinci</a></li>
                            <?php
                            if($row['youtube'] != "")
                            {
                                ?>
                                <li><a href="#review" data-toggle="tab">Iklan produk</a></li>
                                <?php
                            }
                            ...
                            {
                                ?>
                                <li><a href="#notes" data-toggle="tab">Tindakan pencegahan</a></li>
                                <?php
                            }
                            ?>
                        </ul>
...
<form id="order_form" action="index.php?url=pay_check&page=<?php echo $page;?>" method="post">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <h4>Silakan salin URL berikut dan bagikan dengan teman-teman Anda, terima kasih</h4>
                <div id="copy_url"></div>
                <button id='copy_btn' style="margin: 10px;" class="btn btn-primary pull-right" data-clipboard-target="#copy_url">Duplikat</button>
                <span id='copy_success' style="display: none;">Berhasil disalin</span>
            </div>
        </div><!-- /.彈出視窗內容 -->
    </div><!-- /.彈出視窗結束 -->
</div>
