    ...
    <div class="container">
        ...
        <div class="aa-catg-head-banner-content">
            <ol class="breadcrumb">
                ...
                <li class="active">Permohonan manajer pemasaran</li>
            </ol>
        </div>
    </div>
</section>
...
<div style="margin-top: 5%;">
    <div class="container panel">
        <h1 align="center">Permohonan manajer pemasaran</h1>
        <hr>
        <div class="row">
            <!-- edit form column -->
...
<!--                    </div>-->
                    ...
                    ?>
                    <div class="form-group">
                        <label class="col-lg-3 control-label">Status permohonan</label>
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label">Kode eksklusif</label>
                        <div class="col-lg-8" style="top:8px;">
                            <span id="manager_no">
                                <?php
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label">Spesifikasi manajer pemasaran</label>
                        <div class="col-lg-8" style="top:3px;">
                            <span>
                                <input type="button" class="btn btn-success" value="Lihat" id="manager_rule" data-toggle="modal" data-target="#manager_modal" role_status="0">
                            </span>
                        </div>
                    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <h4>Spesifikasi manajer pemasaran</h4>
                <div>
                    <?php
...
if(@$_POST['btn'] && $_POST['self_introduction'] != "")
{
    ...
    <script>
        ...
        location.href='index.php?url=to_manager&page=<?php echo $page;?>';
    </script>
    <?php
}
?>
